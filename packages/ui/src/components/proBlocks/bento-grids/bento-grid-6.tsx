    ...
    <section className="bg-background py-16 md:py-24">
      <div className="container mx-auto px-6 flex flex-col gap-12">
        ...
        <div className="grid grid-cols-1 gap-3 lg:grid-cols-3 lg:grid-rows-2">
          ...
          <Card className="rounded-xl lg:col-span-2 overflow-hidden shadow-none bg-muted/80 border-none">
            <Image
          ...
          <Card className="rounded-xl lg:col-span-1 overflow-hidden shadow-none bg-muted/80 border-none">
            <Image
              src="https://ui.shadcn.com/placeholder.svg"
              alt="Placeholder"
              className="w-full object-cover h-80"
