export const Frame = () => {
  return (
    <div
      className="bg-white overflow-hidden w-full min-w-[1280px] min-h-[4585px] relative"
      data-model-id="1:344"
    >
      <img
      ...
      <div className="absolute top-0 left-0 w-[1280px] h-7 bg-black" />
      ...
      <div className="absolute top-7 left-0 w-[1280px] h-14 bg-black" />

      <div className="inline-flex items-center gap-3 absolute top-[49px] left-[calc(50.00%_-_110px)]">
        <div className="relative w-fit mt-[-1.00px] [font-family:'Playfair_Display',Helvetica] font-medium text-white text-xs tracking-[-0.24px] leading-[normal]">
          About
        </div>
