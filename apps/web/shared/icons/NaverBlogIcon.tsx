...
export function NaverBlogIcon({ size = 24, className, ...props }: LucideProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 924.43 1000"
      width={size}
      height={size} // Maintain aspect ratio or fit container? Lucide usually squares it, but this viewbox is not square.
      // However the user expects an icon that fits well. Let's stick to standard behavior.
      fill="currentColor"
      className={className}
      {...props}
    >
