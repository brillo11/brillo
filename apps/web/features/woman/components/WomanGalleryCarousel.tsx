...
const GALLERY_ITEMS = [
  {
    before: "/page/woman/4-2x.png",
    after: "/page/woman/4.png",
    label: "Case 1",
  },
  {
    before: "/page/woman/f.png",
    after: "/page/woman/f-1.png",
    label: "Case 2",
  },
  {
    before: "/page/woman/b-3.png",
    after: "/page/woman/a-3.png",
    label: "Case 3",
  },
  {
    before: "/page/woman/b-4.png",
    after: "/page/woman/a-4.png",
    label: "Case 4",
  },
  {
    before: "/page/woman/b-5.png",
    after: "/page/woman/a-5.png",
    label: "Case 5",
  },
  {
    before: "/page/woman/b-6.png",
    after: "/page/woman/a-6.png",
    label: "Case 6",
  },
];
...
export const WomanGalleryCarousel = () => {
  ...
  useEffect(() => {
    const loop = (time: number) => {
      if (lastTimeRef.current) {
        // Dynamic Speed: Faster on mobile (1.0px), normal on desktop (0.5px)
