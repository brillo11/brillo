import { getPopularPosts } from "@/serverActions/post.actions";
...
export default async function ProductPage() {
  // 리뷰 게시글 가져오기
  const reviewPosts = await getPopularPosts(3);

  // 가상의 제품 데이터
  const product = {
    id: "premium-product-001",
    name: "프리미엄 라이프스타일 제품",
    price: 89000,
      ...
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <Link href="/detail" className="hover:text-gray-900">
              제품
            </Link>
            <span>/</span>
              ...
              <div>
                ...
                <div className="flex gap-2">
                  {["블랙", "화이트", "네이비"].map((color) => (
                    <button
                      key={color}
                      className="px-4 py-2 border border-gray-300 rounded-lg hover:border-emerald-500 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20"
                    >
                      {color}
                    </button>
                  ))}
                      ...
                      <div className="space-y-4">
                        {reviewPosts.map((review) => (
                          ...
                          >
                            ...
                            <Link
                              href={`/board/${review.board.slug}/${review.slug}`}
              ...
              >
                <CardContent className="p-4">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-sm">4.7 (89)</span>
                  </div>
                </CardContent>
              </Card>
            ))}
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-4 md:hidden">
          <div className="flex gap-3">
            <Button variant="outline" size="sm" className="flex-1">
              <Heart className="h-4 w-4 mr-2" />찜
            </Button>
            <Button
              size="sm"
        ...
        <div className="max-w-7xl mx-auto px-4 pb-8">
          <div className="p-4 bg-white rounded-lg shadow text-xs space-y-2">
            ...
            <div className="grid grid-cols-2 gap-4 text-gray-600">
              <div>
                <p>
                  <strong>페이지 타입:</strong> 제품 상세/구매 페이지
                </p>
                <p>
                  <strong>렌더링:</strong> ISR (1시간마다 재생성)
                </p>
                <p>
              ...
              <div>
                <p>
                  <strong>리뷰 수:</strong> {reviewPosts.length}개
                </p>
                <p>
                  <strong>재고 상태:</strong>{" "}
