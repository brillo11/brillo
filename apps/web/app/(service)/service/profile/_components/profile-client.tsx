...
export function ProfileClient({ user }: ProfileClientProps) {
  ...
  const [activeTab, setActiveTab] = useState<"PROFILE" | "BLOG" | "INSTAGRAM" | "THREAD" | "VIDEO">("PROFILE");
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="bg-vzx-card border border-white/10 rounded-2xl p-8 space-y-6">
                   <div className="flex items-center gap-4">
                     ...
                     <div>
                       <h2 className="text-xl font-bold text-white">{user?.nickname || user?.name || "사용자"}</h2>
