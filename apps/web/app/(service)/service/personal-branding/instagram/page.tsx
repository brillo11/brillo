...
export default function Instagram() {
  ...
  const handleGenerateImages = async () => {
    ...
    // Process parallel or sequential? Sequential is better for rate limits/errors visualization
    // Parallel for speed. With Gemini 3 flash/pro preview, let's try parallel but limited?
    // Let's do simple Promise.all for now.
